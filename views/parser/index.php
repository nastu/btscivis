...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="../../../public/dist/img/jenkins.ico" type="image/x-icon"/>
    <link rel="shortcut icon" href="../../../public/dist/img/jenkins.ico" type="image/x-icon"/>
    <!-- Bootstrap 3.3.6 -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>CI</b> BTS Development</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="../../../public/dist/img/jenkins.png" class="img-circle" alt="User Image">
                </div>
